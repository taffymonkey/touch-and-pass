...
const styles = StyleSheet.create({
  ...
  kitPanel: { flex: 1, alignItems: 'center' },
  kitImage: { width: 70, height: 90 },
  kitPlaceholder: { width: 70, height: 90, borderRadius: 8, alignItems: 'center', justifyContent: 'center', opacity: 0.6 },
